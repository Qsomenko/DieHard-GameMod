--[[
    ...
    CLIENT(Клиент)
    filter(фильтр)
    IsValid - Возвращает, является ли объект действительным или нет.
        (Например, entitys, panels, custom bale и другое).
        Проверяет, что объект не равен нулю, имеет метод isValid и 
        возвращает ли этот метод значения true.
]]
